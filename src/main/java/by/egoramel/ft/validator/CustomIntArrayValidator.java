...
public final class CustomIntArrayValidator {
    private static final Logger LOGGER = LogManager.getLogger(CustomIntArrayValidator.class);
    private final static int NEGATIVE_SIZE = 0;

    public static void validationOnNegativeSize(final int size) {
    ...
    public static void validateStringList(final List<String> stringList) {
    ...
    public static void validateCustomIntArray(final CustomIntArray customIntArray, final String message) {
    ...
    public static void validateArray(final int[] array) {
    ...
    public static void validateBounds(final int index, final int arrayLength) {
